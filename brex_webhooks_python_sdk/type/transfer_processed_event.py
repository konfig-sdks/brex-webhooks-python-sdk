...
class RequiredTransferProcessedEvent(TypedDict):
...
class OptionalTransferProcessedEvent(TypedDict, total=False):
...
class TransferProcessedEvent(RequiredTransferProcessedEvent, OptionalTransferProcessedEvent):
    pass
