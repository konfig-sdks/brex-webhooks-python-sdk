...
class UpdateWebhookSubscriptionRequest(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def status() -> typing.Type['UpdateWebhookSubscriptionStatus']:
                return UpdateWebhookSubscriptionStatus
            __annotations__ = {
                "url": url,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["status"]) -> 'UpdateWebhookSubscriptionStatus': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["url", "event_types", "status", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["status"]) -> 'UpdateWebhookSubscriptionStatus': ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["url", "event_types", "status", ], str]):
